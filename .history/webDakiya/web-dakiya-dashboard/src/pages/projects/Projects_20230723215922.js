...
export default function Projects() {
  ...
  return <>
    ...
    {!isProjectLoading && projects.length > 0 &&
        ...
        projects.map(project => <Grid item xs={12} md={4}><ProjectCard createdAt={new Date(project.createdAt)} vapidKey={project.publicVAPID} icon="eos-icons:project" sx={{ margin: '10px' }} title={project.name} /></Grid>)}
