...
export default function Projects() {
  ...
  return <>
    ...
    {!isProjectLoading && projects.length > 0 && projects.map(project => <ProjectCard desc={`Public Vapid Key: ${project.publicVAPID}`} icon="eos-icons:project" sx={{margin:'10px'}} title={project.name}/>)}
  </>
