...
exports.validateUserData = async (req, res, next) => {
  ...
  console.log("🚀 ~ file: signup-controller.js:14 ~ exports.validateUserData= ~ email, password, firstName, lastName:", email, password, firstName, lastName)
...
exports.signupController = async (req, res) => {
  console.log("🚀 ~ file: signup-controller.js:44 ~ exports.signupController= ~ req:", req)
  const { email, password, firstName, lastName } = req.body;
