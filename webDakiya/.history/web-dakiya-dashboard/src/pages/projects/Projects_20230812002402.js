...
useEffect(() => {
  ...
  return <>
    ...
    { _projects.length > 0 &&
        ...
        _projects.map(project => <Grid item xs={12} md={4}><ProjectCard setSelectedProject={_setSelectedProject} deleteProjectHandler={()=>deleteProjectHandler(project.id)} createdAt={project.createdAt} vapidKey={project.publicVAPID} icon="mdi:push-notification" sx={{ margin: '10px' }} title={project.name} /></Grid>)}
