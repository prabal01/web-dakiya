...
export default function ProjectCard({ deleteProjectHandler, title, createdAt, vapidKey, icon, color = 'primary', sx, ...other }) {
  ...
  const {selectedProject,setSelectedProject} =  useProjectStore((state=>({selectedProject:state.selectedProject, setSelectedProject:state.setSelectedProject})))
...
const deleteModalContent = (
  ...
  return (
    ...
    >
      ...
      <button onClick={setSelectedProject(!boolean(selectedProject))}>test</button>
