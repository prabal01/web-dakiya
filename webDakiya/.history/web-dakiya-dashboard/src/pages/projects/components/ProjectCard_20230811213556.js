...
const handleDelete = () => {
  if (confirmationText === 'Yes I want to delete it') {
...
const deleteModalContent = (
  <>
    <Typography variant="body1" gutterBottom>
      A project once deleted, it cannot be retrieved.
    </Typography>
    <TextField
        ...
        helperText={!isConfirmationValid && 'Invalid confirmation text'}
      />
  </>
);
  return (
      ...
      <div style={{display:'flex', justifyContent:"space-between", padding:'0 20px', marginTop:"-25px", marginBottom:"15px"}}>
        ...
        <div >
          ...
          <StyledModal
            ...
            actions={
              <>
                <Button style={{marginRight:'10px'}} onClick={deleteProjectHandler} variant="contained" color="error">
                  Delete
                </Button>
