...
import animation from "../../../globalStyles/customAnimaitons.module.css"
...
export default function ProjectCard({ setSelectedProject,deleteProjectHandler, title, createdAt, vapidKey, icon, color = 'primary', sx, ...other }) {
  ...
  return (
    ...
    >
      <div  onclick={() => {
        console.log("clicked")
        setSelectedProject()
      }} style={{display:'flex', justifyContent:"space-between", padding:'0 20px', marginTop:"-25px", marginBottom:"15px"}}>
